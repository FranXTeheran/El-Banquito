...
<head>
    ...
    <title>Acceso | El Banquito</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center font-poppins">
    ...
    <div class="flex flex-col md:flex-row w-full md:w-[900px] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="hidden md:flex md:w-1/2 relative flex-col justify-end text-white min-h-[500px] overflow-hidden">
            <img src="../img/imagen-mujer-login.png" class="absolute inset-0 w-full h-full object-cover" alt="FamilyBank">
            <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-purple-700/60"></div>
            <div class="relative z-10 p-12">
                <h1 class="text-3xl font-light mb-4">Preparate para llevar el control familiar</h1>
        ...
        <div class="w-full md:w-1/2 bg-white p-8 md:p-16 text-gray-800">
            ...
            <p class="text-gray-400 text-sm mb-6">Inicia sesion para ver tus ingresos</p>
            ...
            <form class="grid gap-3" action="../process/login_process.php" method="POST">
                ...
                <button class="w-full bg-gradient-to-br from-blue-600 to-purple-700 p-2 text-white rounded-xl text-sm mt-2 hover:opacity-90 transition" type="submit">Iniciar Sesion</button>
                
                <p class="text-sm text-center"><a href="register.php" class="text-sky-600 font-medium hover:underline"></a></p>
            </form>
        </div>
